...
glm_3 <- glm(vote_PCQ ~  region + age + gender + education_cat + income_cat5 + language + MarketLib_index + moralT_index + integration_index + indy + economy + covidDis_index + immig_index + issue_economy + issue_health + issue_enviro + issue_education + issue_imm + issue_housing + issue_taxes + issue_indy + issue_col + issue_fr, data = df, family = "binomial", weights = pes_weight_general)
